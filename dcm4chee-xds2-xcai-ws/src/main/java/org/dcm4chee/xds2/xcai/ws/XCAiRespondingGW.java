...
package org.dcm4chee.xds2.xcai.ws;
...
@DeactivateableByConfiguration(extension = XCAiRespondingGWCfg.class)
public class XCAiRespondingGW implements XCAIRespondingGatewayPortType {
    ...
    private XCAiRespondingGWCfg cfg;
    
    @PostConstruct
    private void init() {
    	cfg = device.getDeviceExtension(XCAiRespondingGWCfg.class);
    }
