...
public class CheckErrorsTest {
    ...
    public static WebArchive createDeployment() {
        return XDSTestUtil.createDeploymentArchive(CheckErrorsTest.class)
            .add(new FileAsset(new File("src/test/resources/org/dcm4chee/xds2/ws/registry/"+TEST_METADATA_FILENAME)), 
                "WEB-INF/classes/org/dcm4chee/xds2/ws/registry/"+TEST_METADATA_FILENAME); 
