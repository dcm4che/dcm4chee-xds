...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-audit-%DCM4CHE_VERSION%.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-core-%DCM4CHE_VERSION%.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-hl7-%DCM4CHE_VERSION%.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-hl7-%DCM4CHE_VERSION%.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-%DCM4CHE_VERSION%.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-audit-%DCM4CHE_VERSION%.jar
